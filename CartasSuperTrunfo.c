...
int main() {
    ...
    int pontos1, pontos2;
    int densidade populacional = populacao1/area1, populacao2/area2
    int pib per Capita = pib1/populacao1, pib2/populacao2
